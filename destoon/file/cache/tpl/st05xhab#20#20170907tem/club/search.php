...
<div class="m">
<div class="nav"><span class="fr mr-10">共找到 <b class="red"><?php echo $items;?></b> 条 相关信息</span> 当前位置: <a href="<?php echo $MODULE['1']['linkurl'];?>">首页</a> &raquo; <a href="<?php echo $MOD['linkurl'];?>"><?php echo $MOD['name'];?></a> &raquo; <a href="<?php echo $MOD['linkurl'];?>search.php">搜索</a></div>
</div>
<div class="m">
...
<td><input type="text" size="10" name="username" value="<?php echo $username;?>" style="padding:3px 0 3px 1px;"/></td>
</tr>
<tr>
...
<table cellpadding="6" cellspacing="1" border="1" bordercolor="#dddddd" width="100%" bgcolor="#dddddd">
<tr bgcolor="#F1F1F1">
<th width="40"></th>
<th>商圈</th>
<th width="100">主题</th>
