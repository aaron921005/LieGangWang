...
<a href="<?php echo $MOD['linkurl'];?>cart.php" target="_blank" rel="nofollow"><i></i>我的购物车(<span class="f_red">
            <script type="text/javascript">document.write(get_cart());</script>
            </span>)</a>
</div>
<div class="head_bprice fl mtb">
<a href="<?php echo $MODULE['2']['linkurl'];?><?php echo $DT['file_my'];?>?mid=16&action=add" target="_blank" rel="nofollow">发布商品</a>
</div>
</div>
 </div>
<div class="clear"></div>
...
<div class="cat_mall">
<dl<?php if(!$navAll) { ?> id="navAll"<?php } ?>
>
<dt><i></i>热门行业</dt>
<dd><?php include template('catalog-mall', 'chip');?></dd><!-- 分类 -->
</dl>
</div>
  <ul class="cat_mall_ul">
<li>
  <a href="<?php echo $MODULE['1']['linkurl'];?>"><span>首页</span></a></li>
  <?php if(isset($MODULE['16'])) { ?><li class="menuon"><a href="<?php echo $MODULE['16']['linkurl'];?>" target="_blank"><?php echo $MODULE['16']['name'];?></a><i class="hot"></i></li><?php } ?>
  <?php if(isset($MODULE['5'])) { ?><li><a href="<?php echo $MODULE['5']['linkurl'];?>" target="_blank"><?php echo $MODULE['5']['name'];?></a></li><?php } ?>
  <?php if(isset($MODULE['6'])) { ?><li><a href="<?php echo $MODULE['6']['linkurl'];?>" target="_blank"><?php echo $MODULE['6']['name'];?></a></li><?php } ?>
  <?php if(isset($MODULE['4'])) { ?><li><a href="<?php echo $MODULE['4']['linkurl'];?>" target="_blank"><?php echo $MODULE['4']['name'];?></a><i class="hot"></i></li><?php } ?>
  <?php if(isset($MODULE['13'])) { ?><li><a href="<?php echo $MODULE['13']['linkurl'];?>" target="_blank"><?php echo $MODULE['13']['name'];?></a></li><?php } ?>
  <?php if(isset($MODULE['22'])) { ?><li><a href="<?php echo $MODULE['22']['linkurl'];?>" target="_blank"><?php echo $MODULE['22']['name'];?></a></li><?php } ?>
  <?php if(isset($MODULE['8'])) { ?><li><a href="<?php echo $MODULE['8']['linkurl'];?>" target="_blank"><?php echo $MODULE['8']['name'];?></a></li><?php } ?>
  <?php if(isset($MODULE['21'])) { ?><li><a href="<?php echo $MODULE['21']['linkurl'];?>" target="_blank"><?php echo $MODULE['21']['name'];?></a></li><?php } ?>
  <?php if(isset($MODULE['18'])) { ?><li><a href="<?php echo $MODULE['18']['linkurl'];?>" target="_blank"><?php echo $MODULE['18']['name'];?></a><i class="hot"></i></li><?php } ?>
    </ul>
    </div>
</div>
