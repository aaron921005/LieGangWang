...
<link rel="stylesheet" type="text/css" href="<?php echo DT_SKIN;?>css/css_<?php echo $css;?>.css"/>
<?php } } ?>
<?php } ?>
<!--[if lte IE 6]>
...
<a class="fr" href="//wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $DT['qq1'];?>&amp;site=<?php echo $DT['qq1name'];?>&amp;menu=yes" target="_blank" rel="nofollow">申请开通分站</a>
</div>
<div class="clear"></div>
<ul>
...
<a href="<?php echo $MODULE['2']['linkurl'];?><?php echo $DT['file_my'];?>?mid=5&action=add" target="_blank" rel="nofollow">发布产品</a>
</div>
<div class="head_bprice fl mtb">
<a href="<?php echo $MODULE['2']['linkurl'];?><?php echo $DT['file_my'];?>?mid=6&action=add" target="_blank" rel="nofollow">发布采购</a>
</div>
</div>
 </div>
<div class="clear"></div>
</div>
<?php include template('top-so');?><!--浮动搜索-->
...
><?php echo $m['name'];?></a> <?php if($m['moduleid']==4 || $m['moduleid']==6 || $m['moduleid']==18) { ?><i class="hot"></i><?php } ?>
</li><?php } ?>
<?php } } ?>
    </ul>
    </div>
