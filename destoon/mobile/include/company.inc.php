...
if($userid || $username) {
    ...
    $bgcolorwap = (isset($HOME['bgcolorwap']) && $HOME['bgcolorwap']) ? $HOME['bgcolorwap'] : '';
...
if($bannert == 2) {
	...
	$bannerw = (isset($HOME['bannerw']) && $HOME['bannerw']) ? intval($HOME['bannerw']) : 300;
    $bannerh = (isset($HOME['bannerh']) && $HOME['bannerh']) ? intval($HOME['bannerh']) : 150;
