...
switch($action) {
	...
	case 'upload':
		...
		require DT_ROOT.'/mobile/memberwap/upload.class.php';
	...
	case 'delete':
		...
		dmsg($L['avatar_delete'], 'wapavatar.php?itemid='.$DT_TIME);
	break;
	default:
    ...
    include template('avatar', 'memberwap');
