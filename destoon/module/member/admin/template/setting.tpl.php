...
<tr>
<td class="tl">签到一天奖励</td>
<td>
<input type="text" size="5" name="setting[credit_qiandao]" value="<?php echo $credit_qiandao;?>"/>
</td>
</tr>
<tr>
<td class="tl">连续签到一天以上奖励</td>
<td>
<input type="text" size="5" name="setting[credit_qiandaos]" value="<?php echo $credit_qiandaos;?>"/>
</td>
</tr>
<tr>
<td class="tl">签到说明</td>
<td>
<textarea name="setting[qiandao_sm]" id="qiandao_sm" style="width:500px;height:50px;"><?php echo $qiandao_sm;?></textarea><br/>支持HTML语法，常用代码： 空格 &amp;nbsp; 换行  &lt;br/&gt;
</td>
</tr>
<tr>
<td class="tl">积分用途</td>
<td>
<textarea name="setting[credit_yt]" id="credit_yt" style="width:500px;height:50px;"><?php echo $credit_yt;?></textarea><br/>支持HTML语法，常用代码：空格 &amp;nbsp; 换行  &lt;br/&gt;
</td>
</tr>
<!--E 每日签到-->
</table>
