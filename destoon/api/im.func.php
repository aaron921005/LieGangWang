...
function im_qqxh($id, $style = 0) {
	return $id ? '<a href="http://wpa.qq.com/msgrd?v=3&uin='.$id.'&site=qq&menu=yes" target="_blank" rel="nofollow"><img src="http://wpa.qq.com/pa?p=1:'.$id.':1" title="点击QQ交谈/留言" alt="" align="absmiddle" onerror="this.src=DT_SKIN+\'img/qqn.png\';" onload="if(this.width==77){this.src=DT_SKIN+\'img/qqn.png\';}else if(this.width==92){this.src=DT_SKIN+\'img/qqs.png\';}"/></a>' : '';
}
